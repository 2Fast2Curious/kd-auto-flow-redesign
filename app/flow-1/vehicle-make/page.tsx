...
export default function Flow1VehicleMakePage() {
  ...
  const handleSelection = (make: string) => {
    router.push("/flow-1/vehicle-model")
  }
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-md shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div>
            ...
            <div className="bg-gray-200 h-2 relative">
              <div className="bg-[#2048A8] h-full w-[62.5%]"></div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2">What is the make of your primary vehicle?</h2>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 max-w-md mx-auto">
              {vehicleMakes.map((make) => (
                <button
                  ...
                  className="bg-white hover:bg-gray-50 border border-gray-300 py-4 rounded text-center flex flex-col items-center justify-center"
                >
                  <div className="mb-2">
                    <Image
