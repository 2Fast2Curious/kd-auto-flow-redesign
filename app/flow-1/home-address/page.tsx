...
export default function Flow1HomeAddressPage() {
  ...
  const handleNext = () => {
    if (address.trim() && zipCode.trim()) {
      router.push("/flow-1/phone-number")
    }
  }
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-md shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div>
            ...
            <div className="bg-gray-200 h-2 relative">
              <div className="bg-[#2048A8] h-full w-[98%]"></div>
            </div>
          </div>
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold mb-2">What is your home address?</h2>
