...
export default function Flow3DrivingLicensePage() {
  const router = useRouter()
  const [selectedOption, setSelectedOption] = useState<string>("")

  const handleSubmit = () => {
    if (selectedOption) {
      router.push("/flow-3/vehicle-year")
    }
  }
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="relative">
            <div className="bg-gray-200 h-2 relative">
              <div className="bg-red-500 h-full w-[37.5%]"></div>
            </div>
            <div className="absolute left-[37.5%] -top-1 transform -translate-x-1/2">
          ...
          <p className="text-center text-sm text-gray-600 mt-2">Progress: 37.5%</p>
        </div>
      </div>

      {/* Main Content */}
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold text-[#1e3a8a] text-center mb-8">Do you have a valid Driving License?</h2>
        ...
        <div className="space-y-4 max-w-lg mx-auto">
          <button
            ...
            className={`w-full border border-gray-300 rounded-lg py-4 px-6 text-center text-[#1e3a8a] font-medium transition-colors ${
              selectedOption === "yes" ? "border-blue-500 bg-blue-50" : "bg-white hover:border-blue-500"
            }`}
          >
            YES
          </button>
          ...
          <button
            ...
            className={`w-full border border-gray-300 rounded-lg py-4 px-6 text-center text-[#1e3a8a] font-medium transition-colors ${
              selectedOption === "no" ? "border-blue-500 bg-blue-50" : "bg-white hover:border-blue-500"
            }`}
          >
            NO
          </button>
