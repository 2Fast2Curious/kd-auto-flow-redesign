...
export default function Flow3VehicleModelPage() {
  ...
  const handleModelSelect = (model: string) => {
    router.push("/flow-3/credit-rating")
  }
      ...
      <div className="bg-white py-4 border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="relative">
            ...
            <div className="absolute left-[5%] -top-1 transform -translate-x-1/2">
          ...
          <p className="text-center text-sm text-gray-600 mt-2">Progress: 75%</p>
        </div>
      </div>

      {/* Main Content */}
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h2 className="text-2xl font-bold text-[#1e3a8a] text-center mb-8">What is the model of your CHEVROLET?</h2>
